...
func test_continuous_persistence_add_gold_creates_save_file_by_next_frame() -> void:
...
func test_continuous_persistence_add_gold_save_reflects_new_gold_value() -> void:
	# Arrange
	GameStore.add_gold(50)
...
func test_continuous_persistence_add_gold_flags_cleared_after_flush() -> void:
...
func test_continuous_persistence_add_gold_save_contains_version_key() -> void:
	# Arrange
	GameStore.add_gold(50)
...
func test_continuous_persistence_add_gold_save_version_equals_constant() -> void:
	# Arrange
	GameStore.add_gold(50)
...
func test_continuous_persistence_three_setters_single_flush_clears_flags() -> void:
...
func test_continuous_persistence_three_setters_all_values_in_single_save() -> void:
...
func test_continuous_persistence_from_dict_does_not_write_save_file() -> void:
