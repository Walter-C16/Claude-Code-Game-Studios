...
func test_companion_state_get_state_returns_relationship_level_key() -> void:
	# Arrange — factory default for artemis has relationship_level=0
	# Act
	var state: Dictionary = _CompanionStateScript.get_state("artemis")
...
func test_companion_state_get_state_unknown_id_returns_empty_dict() -> void:
	# Arrange / Act
	var state: Dictionary = _CompanionStateScript.get_state("zeus")
...
func test_companion_state_get_romance_stage_level_55_returns_stage_2() -> void:
	...
	# Act
	var stage: int = _CompanionStateScript.get_romance_stage("artemis")
...
func test_companion_state_get_romance_stage_level_91_returns_stage_4() -> void:
	# Arrange
	GameStore._set_relationship_level("artemis", 91)
...
func test_companion_state_romance_stage_does_not_decrease_when_level_drops() -> void:
	...
	GameStore._set_relationship_level("artemis", 75)
	var stage_before: int = _CompanionStateScript.get_romance_stage("artemis")
	assert_int(stage_before).is_equal(3)

	# Act — drop below stage-3 threshold (71)
	GameStore._set_relationship_level("artemis", 65)

	# Assert — stage stays at 3
	var stage_after: int = _CompanionStateScript.get_romance_stage("artemis")
...
func test_companion_state_romance_stage_stays_at_max_after_level_reset_to_zero() -> void:
	...
	var stage: int = _CompanionStateScript.get_romance_stage("hipolita")
	assert_int(stage).is_equal(2)
...
func test_companion_state_set_relationship_level_clamps_above_100() -> void:
	# Arrange / Act
	_CompanionStateScript.set_relationship_level("artemis", 105)

	# Assert — GameStore stores 100
	var stored: int = GameStore.get_relationship_level("artemis")
	assert_int(stored).is_equal(100)

func test_companion_state_set_relationship_level_clamps_below_zero() -> void:
	# Arrange / Act
	_CompanionStateScript.set_relationship_level("artemis", -10)
...
func test_companion_state_set_relationship_level_stores_valid_value_unmodified() -> void:
	# Arrange / Act
	_CompanionStateScript.set_relationship_level("hipolita", 50)
...
func _disabled_test_companion_state_set_relationship_level_emits_romance_stage_changed_on_transition() -> void:
	...
	_CompanionStateScript._max_stages.erase("atenea")

	# Act — cross the stage-1 threshold (21)
	_CompanionStateScript.set_relationship_level("atenea", 25)
...
func _disabled_test_companion_state_romance_stage_changed_carries_correct_old_and_new_stage() -> void:
	...
	_CompanionStateScript.set_relationship_level("nyx", 55)
...
func _disabled_test_companion_state_set_relationship_level_no_signal_when_stage_unchanged() -> void:
	...
	_CompanionStateScript.set_relationship_level("artemis", 100)
...
func _disabled_test_companion_state_set_relationship_level_no_signal_when_level_increases_within_same_stage() -> void:
	...
	_CompanionStateScript.set_relationship_level("hipolita", 30)
